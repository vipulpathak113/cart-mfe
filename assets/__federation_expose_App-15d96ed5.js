...
import useStore from './__federation_expose_Store-1a0c98d5.js';
...
const Summary = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-96 flex flex-col gap-3 px-8 py-6 bg-[#F6F7FF] shadow-sm rounded-md", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-[1px] w-full bg-gray-300" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "bg-blue-600 grow p-3 text-white rounded-full text-sm font-semibold", children: "Proceed to Checkout" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", className: "bg-yellow-400 grow p-3 text-[#232C65] rounded-full text-sm font-semibold flex flex-nowrap gap-3 items-center justify-center", children: [
      "Checkout with ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: "Checkout with Google Pay"
      }
    )
  ] });
};
