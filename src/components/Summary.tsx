...
const Summary = () => {
  return (
    <div className="w-96 flex flex-col gap-3 px-8 py-6 bg-[#F6F7FF] shadow-sm rounded-md">
      ...
      <div className="h-[1px] w-full bg-gray-300"></div>
      <button type="button" className="bg-blue-600 grow p-3 text-white rounded-full text-sm font-semibold">
        Proceed to Checkout
      </button>
      <button type="button" className="bg-yellow-400 grow p-3 text-[#232C65] rounded-full text-sm font-semibold flex flex-nowrap gap-3 items-center justify-center">
